...
# Data parameters
data_folder = 'C:/Users/sidew/Desktop/av/New folder'  # folder with data files
...
def main():
    ...
    train_loader = SequenceLoader(data_folder="C:/Users/sidew/Desktop/av/New folder",
                                  source_suffix="en",
                                  target_suffix="de",
                                  split="train",
                                  tokens_in_batch=tokens_in_batch)
    val_loader = SequenceLoader(data_folder="C:/Users/sidew/Desktop/av/New folder",
                                source_suffix="en",
                                target_suffix="de",
                                split="val",
                                tokens_in_batch=tokens_in_batch)
...
def train(train_loader, model, criterion, optimizer, epoch, step):
    ...
    for i, (source_sequences, target_sequences, source_sequence_lengths, target_sequence_lengths) in enumerate(
        ...
        # Forward prop.
        predicted_sequences = model(source_sequences, target_sequences, source_sequence_lengths, target_sequence_lengths)


        loss = criterion(inputs=predicted_sequences, targets=target_sequences[:, 1:], lengths=target_sequence_lengths - 1)
...
def validate(val_loader, model, criterion):
    ...
    with torch.no_grad():
        ...
        for i, (source_sequence, target_sequence, source_sequence_length, target_sequence_length) in enumerate(
            ...
            # Forward prop.
            predicted_sequence = model(source_sequence, target_sequence, source_sequence_length, target_sequence_length)
